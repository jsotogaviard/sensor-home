...
export default class XiaomiMiScale {
    ...
    static toPoint(peripheral) {
        ...
        const hours = parseInt(serviceDataHex.substring(14, 16), 16)
        const min = parseInt(serviceDataHex.substring(16, 18), 16)
        const sec = parseInt(serviceDataHex.substring(18, 20), 16)
        const weighingDate = new Date(year, month - 1, day, hours, min, sec, 0);
